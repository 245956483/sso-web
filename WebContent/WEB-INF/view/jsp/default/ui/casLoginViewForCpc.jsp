...
<link rel="stylesheet" href="res/cpc/css/cpc.css">
...
<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">		
		<div class="box">
  <div class="top">
     <div class="logo"><img src="res/cpc/images/logo.png" /></div>
	 
  </div>
  <div class="main">
      <div class="left"><img src="res/cpc/images/left.jpg" /></div>
	  <div class="right">
	     <div class="r1">
		 <div class="r2">
		    <div class="r3">
  ...
  <tr>
    <td align="left" style="padding-bottom:12px;"><img src="res/cpc/images/dl.jpg" /></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<img src="res/cpc/images/denglu.jpg" width="102" height="35" onclick="SetPwdAndChk();fm1.submit();"/></td>
