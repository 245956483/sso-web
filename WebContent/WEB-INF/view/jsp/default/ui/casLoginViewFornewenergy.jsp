...
<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
 <div class="w12 header">
   <a class="db logo fl"><img style="padding-top: 10px; width:600px;" src="res/newenergy/images/logo.jpg"   alt=""></a>
   <div class="fr logofr">
...
<div class="box">
  ...
  <div class="main">
      <div class="left"><img src="res/newenergy/images/left.jpg" /></div>
	  <div class="right">
	     <div class="r1">
		 <div class="r2">
		    <div class="r3">
  ...
  <tr>
    <td align="left" style="padding-bottom:12px;"><img src="res/newenergy/images/dl.jpg" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="21%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/forgotPassword.do?layout=newenergy">忘记密码</a></td>
  </tr>
</table></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<img src="res/newenergy/images/denglu.jpg" width="102" height="35" onclick="SetPwdAndChk();fm1.submit();"/></td>
	<td width="62%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/regirsterForNewEnergy.do">立即注册 </a></td>
  </tr>
</table></td>
  </tr>
</table>
