...
<link href="res/cserverhrMobile/css/phonehrMobile.css" rel="stylesheet" type="text/css"/>
...
<body id="cas" class="login_body">
  ...
  <img src="res/cserverhrMobile/images/bannerHRMobile.png" width="100%" height="150px" />
  <div class="form-unit">
...
function goRegister(){
	window.location.href="http://<%=ReadConfig.getString("host.platform") %>/registerUserHRMobile.do?service="+encodeURIComponent("/addToTaskList.do?layout=cserverhr&type=0&state=3&systemTemplateId=<%=systemTemplateId%>");
}
function goReset(){
	window.location.href="http://<%=ReadConfig.getString("host.platform") %>/pwdResetHR.do?service="+encodeURIComponent("/addToTaskList.do?layout=cserverhr&type=0&state=3&systemTemplateId=<%=systemTemplateId%>");
}
//用户登录时的校验
function check(){
