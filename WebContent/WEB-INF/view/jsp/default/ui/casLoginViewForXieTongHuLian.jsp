...
%>
	...
	<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">		
		<div class="box">
  <div class="top">
     <div class="logo"><img src="res/xietonghulian/images/logo.jpg" /></div>
	 <div class="email">客服电话：4001380766     QQ:122252498</div>
  </div>
  <div class="main">
   <div class="left"><img src="res/xietonghulian/images/left.jpg" /></div>
   <div class="right">
   <div class="r1">
   <div class="r2">
   <div class="r3">
  ...
  <tr>
    <td align="left" style="padding-bottom:12px;"><img src="res/xietonghulian/images/dl.jpg" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="21%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/forgotPassword.do?layout=xietonghulian">忘记密码</a></td>
  </tr>
</table></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<img src="res/xietonghulian/images/denglu.jpg" width="102" height="35" onclick="SetPwdAndChk();fm1.submit();"/></td>
    <td width="62%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/registeruser.do?layout=xietonghulian&service=<%=service%>">立即注册</a></td>
  </tr>
</table></td>
  </tr>
</table>
