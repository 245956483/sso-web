...
<meta charset="utf-8">
<title>登录</title>
<link rel="stylesheet" href="res/rootcloud/css/rootcloud.css">
...
<div class="header" style="background:#0064ba">
  <div class="w1220  cl"> <a href="http://rootcloud.csaas.com.cn"><img class="logo" src="res/rootcloud/images/rootcloudlogo.png" style="width:200px;"/></a>
    <div class="l">
      <ul class="nav cl">
        <li><a href="http://rootcloud.csaas.com.cn" style="color:#fff;">应用商店</a></li>
		<!--
    ...
    <div class="nav_r">
      <div class="search cl">
        <form class="l" action="/search.jspx" target="_blank" id="searchForm">
          ...
          <span class="search_span"><img src="res/rootcloud/images/sousuo.png"/></span>-->
        </form>
...
<div class="w1220 cl" style="padding:80px 0px;">
  <div class="w840 l">
    <ul class="kuai">
      <li class="kuai_one cl"><a href="http://rootcloud.csaas.com.cn" target="_blank"><img src="res/rootcloud/images/ico1.png"/><font>
        <h1>综合办公管理</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one tow cl"><a href="http://rootcloud.csaas.com.cn" target="_blank"><img src="res/rootcloud/images/ico2.png"/><font>
        <h1>合同管理</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one three cl"><a href="http://rootcloud.csaas.com.cn" target="_blank"><img src="res/rootcloud/images/ico5.png"/><font>
        <h1>HR高校</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one four cl"><a href="http://rootcloud.csaas.com.cn" target="_blank"><img src="res/rootcloud/images/ico3.png"/><font>
        <h1>OA企业版</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one five cl"><a href="http://rootcloud.csaas.com.cn" target="_blank"><img src="res/rootcloud/images/ico4.png"/><font>
        <h1>车辆管理</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one six cl"><a href="http://rootcloud.csaas.com.cn" target="_blank"><img src="res/rootcloud/images/ico5.png"/><font>
        <h1>HR企业</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one eight" style="float:right;"><a href="http://rootcloud.csaas.com.cn" target="_blank"><font>
        <h2>协同办公OA系统</h2>
        <h3>云计算平台</h3>
      ...
      <li class="kuai_one nine cl"><a href="http://rootcloud.csaas.com.cn" target="_blank"><img src="res/rootcloud/images/ico1.png"/><font>
        <h1>绩效考核管理</h1>
        <span>了解更多</span></font></a></li>
    </ul>
  </div>
     ...
     <div class="login">
		...
		<%}%>			  
		 ...
		 <span id="register" style="display:none; height:18px; color: red;font-size: 14px;font-weight: bold;">注册成功,请登录</span><span id="createSys" style="display:none; height:18px; color: red;font-size: 14px;font-weight: bold;">开通成功,请登录</span>
		  ...
		  <a href="http://<%=ReadConfig.getString("host.platform")%>/saasForgotPassword.do?layout=rootcloud">忘记密码了吗？</a></div>
		  ...
		  <div class="zhuce pt8">
		  <% if(isv!=null){ %>
		           <a href="http://<%=ReadConfig.getString("host.platform")%>/saasRegisterIsv.do?layout=rootcloud">还不是服务商？立即注册</a>
		   <%}else{%>
		          <a href="http://<%=ReadConfig.getString("host.platform")%>/saasRegisteruser.do?layout=rootcloud">还不是用户？立即注册</a>         
			<%}%>			  		  
		  <span></span></div>
		 </div>
		</div>
...
<div class="foot">
  <div class=" w1220  cl">
    <div  class="foot_left" style="   margin-top: 35px;"> 
	
      <div class="foot_address cl" > <img src="res/rootcloud/images/foot_y.png"/>
        <p>版权:Copyright 2018 All Rights Reserved. 根云 版权所有</br>
          地址：北京市海淀区西北旺东路10号院东区5号楼6层606号  &nbsp;电话：400-868-1122 &nbsp;邮箱： &nbsp;partner@rootcloud.com
    ...
    <div class="foot_right"><font class="cl"><img src="res/rootcloud/images/phone.png"/>
      <h1>服务热线</h1>
      </font> <span>400-868-1122</span> </div>
  </div>
</div>
