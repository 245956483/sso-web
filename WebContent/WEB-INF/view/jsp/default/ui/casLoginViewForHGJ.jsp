...
<head>
<title>协同应用开发框架--登录</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<link href="res/hgj/css/hgj.css" rel="stylesheet"/>
...
<body id="cas" class="login_body" style="background: url('');">
	...
	<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">		
	  <div class="box">
	  <div class="top">
	     <div class="logo"><img src="res/hgj/images/logo.jpg" /></div>
		 <div class="email"></div>
	  </div>
	  <div class="main">
      <div class="left"><img src="res/hgj/images/left.jpg" /></div>
	  <div class="right">
	     <div class="r1">
		 <div class="r2">
		    <div class="r3">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
			    <td align="left" style="padding-bottom:12px;"><img src="res/hgj/images/dl.jpg" /></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<img src="res/hgj/images/denglu.jpg" width="102" height="35" onclick="SetPwdAndChk();fm1.submit();"/></td>
			    <td width="62%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/registeruser.do?layout=hgj&service=<%=service%>">立即注册</a></td>
			  </tr>
			</table></td>
			  </tr>
			</table>
