...
<head>
<meta charset="UTF-8">
<meta name="keywords" content="工业互联网平台,工业云,工业大数据,中服软件,工业PaaS,工业APP,工业4.0,工业互联网,工业智能,工业大数据解决方案">
<meta name="description" content="工业互联网平台,工业云,工业大数据,中服软件,工业PaaS,工业APP,工业4.0,工业互联网,工业智能,工业大数据解决方案">
<title>登录</title>
<link href="res/microbill/css/style.css" rel="stylesheet">
<link href="res/microbill/css/login.css" rel="stylesheet">
...
<iframe id="myiframe" src="<%=ReadConfig.getString("zzhouiipdomain")%>/ggtb/index.jhtml &#10;&#10;" style="border-style:none;width:100%;height:70px;min-width:1220px" border:0;fremeborder:0;frameborder="0" scrolling="no">
</iframe>
</div>
<!----------------------------banner---------------------------->
<!--------------------main-------------------------->
<div class="main LoginBg">
    <div class="main_wh">
       <div class="loginLf lf"> <img src="res/microbill/images/poster.png"></div>
                  ...
                  <div class="LoginForm">
                      <div class="LoginDiv">
					   <c:if test="${not empty sessionScope.openIdLocalId}">
							...
							<span class="spanName"><img src="res/microbill/images/user.jpg"></span>
                      ...
                      <div class="LoginDiv">
					  <span class="spanName"><img src="res/microbill/images/password.jpg"></span>
					 ...
					 <c:choose>
                      ...
                      <div class="LoginDiv">
                          ...
                          <span class="forgetPass"><a href="http://<%=ReadConfig.getString("host.platform")%>/saasForgotPassword.do?layout=microbill">忘记密码</a></span>
                      </div>
					...
					<button class="aBtn redBg lf"   name="submit" accesskey="l"   tabindex="4" type="submit" onclick="" value="登录">登录</button>
                      ...
                      <div class="LoginDiv">
					   <% if(isv!=null){ %>
							   <a href="http://<%=ReadConfig.getString("host.platform")%>/saasRegisterIsv.do?layout=microbill" class="aBtn GrayBg">还不是服务商？立即注册</a>
					   <%}else{%>
							  <a href="http://<%=ReadConfig.getString("host.platform")%>/saasRegisteruser.do?layout=microbill" class="aBtn GrayBg">还不是用户？立即注册</a>   					  
						<%}%>	
...
<!----------------------------footer---------------------------->
<iframe id="myiframe" src="<%=ReadConfig.getString("zzhouiipdomain")%>/ggdb/index.jhtml &#10;&#10;" style="border-style:none;width:100%;height:350px;min-width:1240px" border:0;fremeborder:0;frameborder="0" scrolling="no">
</iframe>
