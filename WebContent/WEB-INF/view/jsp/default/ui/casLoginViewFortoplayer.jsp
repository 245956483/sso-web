...
<link rel="stylesheet" href="res/toplayer/css/index.css">
...
<div class="header">
  <div class="w1220  cl"> <a href="http://toplayer.csaas.com.cn"><img class="logo" src="res/toplayer/images/toplayer.png"/></a>
    <div class="l">
      <ul class="nav cl">
        <li><a href="http://toplayer.csaas.com.cn" style="color:#fff;">应用商店</a></li>
		<!--
    ...
    <div class="nav_r">
      <div class="search cl">
        <form class="l" action="/search.jspx" target="_blank" id="searchForm">
          ...
          <span class="search_span"><img src="res/toplayer/images/sousuo.png"/></span>-->
        </form>
...
<div class="w1220 cl" style="padding:80px 0px;">
  <div class="w840 l">
    <ul class="kuai">
      <li class="kuai_one cl"><a href="http://toplayer.csaas.com.cn" target="_blank"><img src="res/toplayer/images/ico1.png"/><font>
        <h1>综合办公管理</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one tow cl"><a href="http://toplayer.csaas.com.cn" target="_blank"><img src="res/toplayer/images/ico2.png"/><font>
        <h1>合同管理</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one three cl"><a href="http://toplayer.csaas.com.cn" target="_blank"><img src="res/toplayer/images/ico5.png"/><font>
        <h1>HR高校</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one four cl"><a href="http://toplayer.csaas.com.cn" target="_blank"><img src="res/toplayer/images/ico3.png"/><font>
        <h1>OA企业版</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one five cl"><a href="http://toplayer.csaas.com.cn" target="_blank"><img src="res/toplayer/images/ico4.png"/><font>
        <h1>车辆管理</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one six cl"><a href="http://toplayer.csaas.com.cn" target="_blank"><img src="res/toplayer/images/ico5.png"/><font>
        <h1>HR企业</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one eight" style="float:right;"><a href="http://toplayer.csaas.com.cn" target="_blank"><font>
        <h2>协同办公OA系统</h2>
        <h3>云计算平台</h3>
      ...
      <li class="kuai_one nine cl"><a href="http://toplayer.csaas.com.cn" target="_blank"><img src="res/toplayer/images/ico1.png"/><font>
        <h1>绩效考核管理</h1>
        <span>了解更多</span></font></a></li>
    </ul>
  </div>
     ...
     <div class="login">
		...
		<%}else{%>
		 ...
		 <span id="register" style="display:none; height:18px; color: red;font-size: 14px;font-weight: bold;">注册成功,请登录</span><span id="createSys" style="display:none; height:18px; color: red;font-size: 14px;font-weight: bold;">开通成功,请登录</span>
		  ...
		  <a href="http://<%=ReadConfig.getString("host.platform")%>/saasForgotPassword.do?layout=toplayer">忘记密码了吗？</a></div>
		  ...
		  <div class="zhuce pt8">
		  <% if(isv!=null){ %>
		           <a href="http://<%=ReadConfig.getString("host.platform")%>/saasRegisterIsv.do?layout=toplayer">还不是服务商？立即注册</a>
		   <%}else{%>
		          <a href="http://<%=ReadConfig.getString("host.platform")%>/saasRegisteruser.do?layout=toplayer">还不是用户？立即注册</a>         
			<%}%>	
...
<div class="foot">
  <div class=" w1220  cl">
    <div  class="foot_left" > 
      ...
      <div class="foot_address cl" > <img src="res/toplayer/images/foot_y.png"/>
        <p>Copyright©2008-2017 toplayer Corporation, All Rights Reserved</br>
          	地址：四川省成都市高新区一环路南三段28号科技开发楼A座518室  &nbsp;电话：028-61516637 &nbsp; <!--建议邮箱： &nbsp; ICP备11002812号-1  -->
    ...
    <div class="foot_right"><font class="cl"><img src="res/toplayer/images/phone.png"/>
      <h1>服务热线</h1>
      </font> <span>028-61516637</span> </div>
  </div>
</div>
