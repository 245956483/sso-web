...
<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">		
 <div class="box">
  <div class="top">
     <div class="logo"><img src="res/taihua/images/logo.png" style="width:470px"/></div>
	 <div class="email">客服电话：400-880-6725或029-88386725<br/>邮箱：support@cserver.cn</div>
  </div>
  <div class="main">
      <div class="left"><img src="res/taihua/images/left.jpg" /></div>
	  <div class="right">
	     <div class="r1">
		 <div class="r2">
		    <div class="r3">
  ...
  <tr>
    <td align="left" style="padding-bottom:12px;"><img src="res/taihua/images/dl.jpg" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="21%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/forgotPassword.do?layout=taihua">忘记密码</a></td>
  </tr>
</table></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<img src="res/taihua/images/denglu.jpg" width="102" height="35" onclick="SetPwdAndChk();fm1.submit();"/></td>
    <td width="62%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/registeruser.do?layout=taihua&service=/listsystemtemplatesother.do?layout=taihua&fromurl=register">立即注册</a></td>
  </tr>
</table></td>
  </tr>
</table>
