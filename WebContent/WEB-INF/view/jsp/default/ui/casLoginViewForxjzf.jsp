...
<link href="res/xjzf/css/xjzf.css" rel="stylesheet" type="text/css">
...
<body id="cas" class="login_body" style="background: url('');">
  ...
  <form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">		
		<div class="box">
  <div class="top">
     <div class="logo"><img src="res/xjzf/images/logozf.jpg" /></div>
	 <div class="email">客服电话：4006866833   邮箱：xinjiang@sina.com</div>
  </div>
  <div class="main">
      <div class="left"><img src="res/xjzf/images/leftfw.jpg" /></div>
	  <div class="right">
	     <div class="r1">
		 <div class="r2">
		    <div class="r3">
  ...
  <tr>
    <td align="left" style="padding-bottom:12px;"><img src="res/xjzf/images/dl.jpg" /></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<img src="res/xjzf/images/denglu.jpg" width="102" height="35" onclick="SetPwdAndChk();fm1.submit();"/></td>
