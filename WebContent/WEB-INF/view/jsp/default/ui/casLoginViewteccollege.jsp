...
<body id="cas" class="login_body" style="background: url('');">	
	<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">		
		<div class="box">
  <div class="top">
     <div class="logo"><img src="res/tecclollege/images/logo.jpg" style="width:470px"/></div>
	 <div class="email">客服电话：029-85583114 &nbsp;&nbsp;地址：西安市雁塔路58号</div>
  </div>
  <div class="main">
      <div class="left"><img src="res/tecclollege/images/left.jpg" /></div>
	  <div class="right">
	     <div class="r1">
		 <div class="r2">
		    <div class="r3">
  ...
  <tr>
    <td align="left" style="padding-bottom:12px;"><img src="res/tecclollege/images/dl.jpg" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="21%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/forgotPassword.do?layout=teccollege"><!--忘记密码  --></a></td>
  </tr>
</table></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<img src="res/tecclollege/images/denglu.jpg" width="102" height="35" onclick="SetPwdAndChk();fm1.submit();"/></td>
    <td width="62%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/registeruser.do?layout=teccollege&service=<%=service%>"><!-- 立即注册 --></a></td>
  </tr>
</table></td>
  </tr>
</table>
