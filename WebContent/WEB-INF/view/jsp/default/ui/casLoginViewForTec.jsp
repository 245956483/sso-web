...
<link rel="stylesheet" href="res/tec/css/index.css"> 
...
%>
	...
	<!--<form:errors></form:errors>	-->	
		<div class="box">
  <div class="top">
     <div class="logo"><img src="res/tec/images/logo.jpg" /></div>
	 <div class="email">客服电话：4006866833   邮箱：teckjt@sina.com</div>
  </div>
  <div class="main">
      <div class="left"><img src="res/tec/images/left.jpg" /></div>
	  <div class="right">
	     <div class="r1">
		 <div class="r2">
		    <div class="r3">
  ...
  <tr>
    <td align="left" style="padding-bottom:12px;"><img src="res/tec/images/dl.jpg" /><span id="register" style="display:none; height:18px; color: red;font-size: 14px;font-weight: bold;">注册成功,请登录</span><span id="createSys" style="display:none; height:18px; color: red;font-size: 14px;font-weight: bold;">开通成功,请登录</span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="21%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/forgotPassword.do?layout=tec">忘记密码</a></td>
  </tr>
</table></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<img src="res/tec/images/denglu.jpg" width="102" height="35" onclick="SetPwdAndChk();fm1.submit();"/></td>
	<% if(!"1".equals(member)){%>
    <td width="62%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/registeruser.do?layout=tec&service=/listsystemtemplatesother.do?layout=tec&fromurl=register">立即注册</a></td>
    <% }else{ %>
    <td width="62%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/registeruser.do?layout=tec&member=1&service=<%=ReadConfig.getString("yyysuo.login") %>/member/contribute_add2.jspx?cid=&layout=tec&fromurl=register&member=1">立即注册</a></td>
    <% } %>
  </tr>
</table></td>
  </tr>
