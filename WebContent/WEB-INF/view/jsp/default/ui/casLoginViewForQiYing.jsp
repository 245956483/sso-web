...
<body id="cas" class="login_body" style="background: url('');">
	...
	<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">		
		<div class="box">
  <div class="top">
     <div class="logo"><img src="res/qiying/images/logo.jpg" /></div>
	 <div class="email"></div>
  </div>
  <div class="main">
      <div class="left"><img src="res/qiying/images/left.jpg" /></div>
	  <div class="right">
	     <div class="r1">
		 <div class="r2">
		    <div class="r3">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="left" style="padding-bottom:12px;"><img src="res/qiying/images/dl.jpg" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="21%" class="zhuce"><a href="http://<%=ReadConfig.getString("host.platform") %>/forgotPassword.do?layout=qiying">忘记密码</a></td>
  </tr>
</table></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<img src="res/qiying/images/denglu.jpg" width="102" height="35" onclick="SetPwdAndChk();fm1.submit();"/></td>
    <td width="62%" class="zhuce"><a title="" target="_blank" href="http://<%=ReadConfig.getString("host.platform") %>/registeruser.do?layout=qiying&service=<%=service%>" class="reg">立即注册</a></td>
  </tr>
</table></td>
  </tr>
</table>
