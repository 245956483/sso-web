...
<link href="res/saasMobile/css/phoneStyle.css" rel="stylesheet" type="text/css"/>
<link href="res/saasMobile/css/menu_xl.css" rel="stylesheet" type="text/css"/>
<link href="res/saasMobile/css/menu.css" rel="stylesheet" type="text/css"/>
<link href="res/saasMobile/css/mui.min.css" rel="stylesheet" type="text/css"/>
<link href="res/saasMobile/css/layui.css" rel="stylesheet" type="text/css"/>
<%
...
<body id="cas" class="login_body">
  ...
  <div class="head">
    <img src="res/saasMobile/images/logoz.png"  class="logo" width="100%" height="150px" />
	
  </div>
  <div class="title" style="top:60px;">
  <a class="mui-icon-arrowleft" style="color: #b1b1b1" href="JavaScript:history.back(-1)"></a>
  <span>登录</span>
  </div>
 
  
  <div class="form-unit" style="margin-top:133px;" >
   ...
   <form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">		
	   ...
	   <div class="line"></div>
	   <div class="tb-auth">
	     <a  onclick="goRegister()" class="btn form-control a-bj">还没有账号？免费注册</a>
		 <a  onclick="goReset()" class="btn form-control a-bj">忘记密码？重置</a>
	</form:form>
...
function goRegister(){
	window.location.href="http://<%=ReadConfig.getString("host.platform") %>/saasRegisteruser.do";
}
function goReset(){
	window.location.href="http://<%=ReadConfig.getString("host.platform") %>/saaspwdReset.do?service="+encodeURIComponent("/addToTaskList.do?type=0&state=3&systemTemplateId=<%=systemTemplateId%>");
}
//用户登录时的校验
function check(){
	$("#loginUser").hide();
