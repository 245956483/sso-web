...
<meta charset="utf-8">
<title>登录</title>
<link rel="stylesheet" href="res/czgyy/css/czgyy.css">
<link rel="stylesheet" href="res/czgyy/css/index.css">
...
%>
<div class="header" style="background:#0064ba">
  <div class="w1220  cl"> <a href="http://czgyy.cz-cloud.com.cn"><img class="logo" src="res/czgyy/images/czgyylogo.png" style="width:196px;height:38px;    padding-top: 6px;"/></a>
    <div class="l">
      <ul class="nav cl">
        <li><a href="http://czgyy.cz-cloud.com.cn" style="color:#fff;">应用商店</a></li>
		<!--
    ...
    <div class="nav_r">
      <div class="search cl">
        <form class="l" action="/search.jspx" target="_blank" id="searchForm">
          ...
          <span class="search_span"><img src="res/czgyy/images/sousuo.png"/></span>-->
        </form>
...
<div class="w1220 cl" style="padding:80px 0px;">
  <div class="w840 l">
    <ul class="kuai">
      <li class="kuai_one cl"><a href="http://czgyy.cz-cloud.com.cn" target="_blank"><img src="res/czgyy/images/ico1.png"/><font>
        <h1>综合办公管理</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one tow cl"><a href="http://czgyy.cz-cloud.com.cn" target="_blank"><img src="res/czgyy/images/ico2.png"/><font>
        <h1>合同管理</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one three cl"><a href="http://czgyy.cz-cloud.com.cn" target="_blank"><img src="res/czgyy/images/ico5.png"/><font>
        <h1>HR高校</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one four cl"><a href="http://czgyy.cz-cloud.com.cn" target="_blank"><img src="res/czgyy/images/ico3.png"/><font>
        <h1>OA企业版</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one five cl"><a href="http://czgyy.cz-cloud.com.cn" target="_blank"><img src="res/czgyy/images/ico4.png"/><font>
        <h1>车辆管理</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one six cl"><a href="http://czgyy.cz-cloud.com.cn" target="_blank"><img src="res/czgyy/images/ico5.png"/><font>
        <h1>HR企业</h1>
        <span>了解更多</span></font></a></li>
      <li class="kuai_one eight" style="float:right;"><a href="http://czgyy.cz-cloud.com.cn" target="_blank"><font>
        <h2>协同办公OA系统</h2>
        <h3>云计算平台</h3>
      ...
      <li class="kuai_one nine cl"><a href="http://czgyy.cz-cloud.com.cn" target="_blank"><img src="res/czgyy/images/ico1.png"/><font>
        <h1>绩效考核管理</h1>
        <span>了解更多</span></font></a></li>
    </ul>
  </div>
     ...
     <div class="login">
		...
		<%}else{%>
		 ...
		 <span id="register" style="display:none; height:18px; color: red;font-size: 14px;font-weight: bold;">注册成功,请登录</span><span id="createSys" style="display:none; height:18px; color: red;font-size: 14px;font-weight: bold;">开通成功,请登录</span>
		  ...
		  <a href="http://<%=ReadConfig.getString("host.platform")%>/saasForgotPassword.do?layout=czgyy">忘记密码了吗？</a></div>
		  ...
		  <div class="zhuce pt8">
		  <% if(isv!=null){ %>
		           <a href="http://<%=ReadConfig.getString("host.platform")%>/saasRegisterIsv.do?layout=czgyy">还不是服务商？立即注册</a>
		   <%}else{%>
		          <a href="http://<%=ReadConfig.getString("host.platform")%>/saasRegisteruser.do?layout=czgyy">还不是用户？立即注册</a>         
			<%}%>	
...
<div class="footer">
    <div class="footer-wh">
        <!--------------------服务与支持-------------------------->
        <div class="" style="padding: 36px 0px;" >
          	<div class="w1220">
            		<div class="cl">
			   <div class="foot_txt_l"><img src="res/czgyy/images/czphone.png"></div> 
			   <div class="foot_txt_center"><h1><a href="#">长治工业云简介</a></h1>
					<span>
					长治工业云为本地乃至全国的IT供应商、服务商、使用者创建一个廉价的网上在线平台，聚集各类资源，打造供需生态圈，加速工业企业、信息产业的融合转型升级。为工业企业提供廉价、方便、高标准的在线软件超市，促进两化融合；为政企提供网上便捷的通道，支持政府迅速掌握企业经营情况，科学规划、布局和决策，提升政府的服务能力，方便企业办事；为企业间搭建便利的通道，提升供需、交易效率，帮助企业推广品牌，提升效益；基于平台准确采集工厂、设备的使用信息，便于管理者及时准确掌握企业的生产状态，准确调度调控，形成智能化生产；为软件企业提供入口，帮助优秀软件云化，快速上云，服务大众，提升软件产品的使用率。
					</span>
			   </div>
		
				 <div class="foot_txt_r"><img src="res/czgyy/images/wexin.png"><span>长治工业云公众号</span></div>
			   </div>		
             </div>
        <div class="footerCont">
          <p> 中国移动通信山西有限公司长治分公司</p>
            <p>北京睿科铭硕科技有限公司</p>
            <p>公司版权所有 © 1997-2017  ·京ICP备18008921号 ·</p>
        </div>
        </div>
    </div>
</div>
